...
namespace Restaurante.RJControls
{
    public class RJDateTimePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        private Color skinColor = Color.White;
        private Color textColor = Color.Black;
        private Color borderColor = Color.Peru;
        private int borderSize = 1;
        //-> Other Values
        private bool droppedDown = false;
        private Image calendarIcon = Properties.Resources.calendarioN;
